...
import { printSection, printError, printKeyValue, createTable, createSpinner, styled, formatPrice, formatTokenAmount, formatAddress, newLine, } from '../lib/ui.js';
...
import { getAllUserPositions, getPositionPnL } from '../lib/contracts.js';
import { fetchTokens } from '../lib/subgraph.js';
export const portfolioCommand = new Command('portfolio')
    ...
    try {
        ...
        printKeyValue('MNT Balance', styled.primary(formatEther(nativeBalance) + ' MNT'));
        // Display Holdings
        newLine();
        ...
        if (positions.length === 0) {
            ...
            for (const pos of positions) {
                ...
                const pnlStr = styled.pnl(formatEther(pnl) + ' MNT', isProfit);
                positionsTable.push([
            ...
            printKeyValue('Total Unrealized PnL', styled.pnl(formatEther(displayPnl) + ' MNT', totalPositionsPnlIsProfit));
        }
        // Summary
        newLine();
