...
import { printSection, printError, printKeyValue, printWarning, createTable, createSpinner, styled, newLine, } from '../lib/ui.js';
...
rwaCommand
    ...
    try {
        ...
        newLine();
        console.log(styled.muted('  Use "pike rwa open <asset>" to open a position'));
    }
    catch (error) {
