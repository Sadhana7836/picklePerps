...
export declare function buyTokens(tokenAddress: string, ethAmount: string, minTokensOut: bigint, password: string, slippagePercent?: number): Promise<{
    hash: string;
    tokensReceived: bigint;
}>;
export declare function sellTokens(tokenAddress: string, tokenAmount: string, minEthOut: bigint, password: string, slippagePercent?: number): Promise<{
    hash: string;
    ethReceived: bigint;
}>;
