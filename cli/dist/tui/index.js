...
\x1b[32m██║     ██║██║  ██╗███████╗  ██║     ███████╗██║  ██║██║     ███████║\x1b[0m
\x1b[32m╚═╝     ╚═╝╚═╝  ╚═╝╚══════╝  ╚═╝     ╚══════╝╚═╝  ╚═╝╚═╝     ╚══════╝\x1b[0m
  \x1b[90mTrade Meme Tokens & RWA on Mantle\x1b[0m
`;
// Check for help flag
...
if (args.includes('--help') || args.includes('-h')) {
    console.log(BANNER);
    console.log(`
\x1b[4mUsage:\x1b[0m pike-trade-terminal [options]
...
\x1b[32mDocumentation:\x1b[0m https://pike-perps.vercel.app/
`);
    process.exit(0);
}
if (args.includes('--version') || args.includes('-v')) {
    console.log('pike-trade-terminal v1.0.0');
    process.exit(0);
}
// Print banner and start the app
console.clear();
console.log(BANNER);
console.log('  Starting Pike Perps Trade Terminal...\n');
...
setTimeout(() => {
    try {
        ...
        console.error('\x1b[31mError starting TUI:\x1b[0m', error.message);
